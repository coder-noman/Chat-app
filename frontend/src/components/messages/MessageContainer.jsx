  ...
  return (
    <div className="md:min-w-[450px] flex flex-col">
      {!selectedConversation ? (
        ...
        <>
          <div className="bg-slate-500 px-4 py-2 mb-2 flex justify-center items-center gap-3">
...
const NoChatSelected = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full py-28 border-t md:border-none border-black">
